...
namespace BspParser::Accessors {
   ...
   */
  size_t getFaceVertexCount(const Structs::Face& face, std::span<const int32_t> surfaceEdges);
   ...
   */
  size_t getFaceTriangleListIndexCount(const Structs::Face& face, std::span<const int32_t> surfaceEdges);
